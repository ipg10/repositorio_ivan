...
public class Auditar {
    ...
    /**
     * metodo que no retorna valor y es usado para cerrar el archivo abierto. 
     */
   ...
   /**
    * metodo que retorna una cadena la cual es la fecha y la hora en ese momento que es llamado
    * @return 
    */
