...
//                listaOperaciones.add(new Operaciones(5, "Agregar Usuario", false));
    ...
    public static void permisosOrtogados(Usuarios usuarios, int numero, int index) { 
        ...
        for (Operaciones rol : usuarios.getRol().getListaOperaciones()) {
            //valida la operacion a realizar para ver si esta permitida para el rol
...
//            }  
    ...
    /**
     * metodo que no devuelve nada y tiene como parametro un index para saber la posicion de la lista de contacto 
     * que se le aplique una accion 
     * @param index 
     */
    public static void preguntarQueHacer(int index){
         //sumo uno al index ya que los array empiezan en la posision 0  
         int num = index+1; 
...
//         System.out.println("Nª Operación:5 Operación a realizar:Agregar Usuario");
    ...
    public static void main(String args[]){
        ...
        //llamamos el metodo crearFicheroPrimeraVez que esta en la clase Aplicacion el cual genera el fichero .txt al iniciar la aplicacion
...
//         System.out.println("Nombre de usuario: " + usuarios.getNombre() + "  Rol:  " + usuarios.getRol().getNombre()); 
         ...
         // para que se demueste que fue modificado
